...
/* Checking if the react version is the same.
   There is a big with react table, and react itself,
   which causes to download 2 different react versions
*/
require("react-dom");
...
/**
 * It takes a CSV file, converts it into an array of objects,
 * and then adds a new property to each
 * object in the array.
 */
export function ReadCsv() {
    ...
    /**
     * It fetches a CSV file, in a json format,
     * then converts it into an array of
     * objects
     *
     */
    function submitFile() {
